    ...
    return (
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                {/* Total Claims Chart */}
                <div className="relative overflow-hidden rounded-2xl bg-dark-200/80 backdrop-blur-sm border border-emerald-500/30 p-6 text-white shadow-xl shadow-emerald-500/10">
                    ...
                    <div className="relative z-10">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <div className="text-right">
                                <div className="text-2xl font-bold text-white">{totalClaimedFormatted}</div>
                                <div className="text-emerald-100 text-sm">YieldBasis</div>
                            </div>
                        </div>
                        <div className="space-y-2">
                            <div className="text-emerald-100 text-sm">Total Tokens Claimed</div>
                ...
                {/* Total Refunds Chart */}
                <div className="relative overflow-hidden rounded-2xl bg-dark-200/80 backdrop-blur-sm border border-rose-500/30 p-6 text-white shadow-xl shadow-rose-500/10">
                    ...
                    <div className="relative z-10">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <div className="text-right">
                                <div className="text-2xl font-bold text-white">{totalRefundedFormatted}</div>
                                <div className="text-rose-100 text-sm">USDC</div>
                            </div>
                        </div>
                        <div className="space-y-2">
                            <div className="text-rose-100 text-sm">Total Refunded</div>
                            <div className="flex items-center justify-between text-sm">
                ...
                <div className="relative overflow-hidden rounded-2xl bg-dark-200/80 backdrop-blur-sm border border-blue-500/30 p-6 text-white shadow-xl shadow-blue-500/10">
                    ...
                    <div className="relative z-10">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <div className="text-right">
                                <div className="text-2xl font-bold text-white">{formatNumber(weiToUSDC(investmentsData.totalInvested), 2)}</div>
                                <div className="text-blue-100 text-sm">USDC Invested</div>
                            </div>
                        </div>
                        <div className="space-y-2">
                            <div className="text-blue-100 text-sm">Investment Activity</div>
                            <div className="flex items-center justify-between text-sm">
                ...
                <div className="relative overflow-hidden rounded-2xl bg-dark-200/80 backdrop-blur-sm border border-purple-500/30 p-6 text-white shadow-xl shadow-purple-500/10">
                    ...
                    <div className="relative z-10">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <div className="text-right">
                                <div className="text-2xl font-bold text-white">{Math.max(investmentsData.totalInvestments).toLocaleString()}</div>
                                <div className="text-purple-100 text-sm">Total Participants</div>
                            </div>
                        </div>
                        <div className="space-y-2">
                            <div className="text-purple-100 text-sm">Unique Users</div>
